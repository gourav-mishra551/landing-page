      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            ...
            <ul class="text-gray-100 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="#3" className="hover:underline">MacOS</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="px-4 py-6 bg-black dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-100 dark:text-gray-300 sm:text-center">© 2023 <a href="##">Gourav™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-5 sm:justify-center md:mt-0">
            <a href="##" class="text-gray-100 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="##" class="text-gray-400 hover:text-gray-400 dark:hover:text-white">
              ...
              <a href="##" className="text-gray-100 hover:text-gray-400 dark:hover:text-white">
              ...
              <a href="##" class="text-gray-100 hover:text-gray-400 dark:hover:text-white">
