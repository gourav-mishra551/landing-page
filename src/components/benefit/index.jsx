  ...
  return (
    <div className="flex max-w-[32rem] flex-col items-center gap-5 text-center md:flex-row md:text-left lg:flex-col lg:text-center">
      <motion.div
        ...
        className="flex w-[150px] h-[150px] items-center justify-center p-5 rounded-3xl bg-gradient-to-r from-indigo-500 min-w-[150px] min-h-150px"
      >
        <Illustration />
      </motion.div>
      <div className="space-y-5">
        <motion.h2 {...framer_title(isDesktop)} className="font-bold text-black">
          {title}
        </motion.h2>
